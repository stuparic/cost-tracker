...
export class AutocompleteController {
  ...
  @ApiOperation({
    ...
    description:
      'Returns a list of previously used shop names, sorted by frequency. Optionally filter by search prefix.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Returns a list of previously used product descriptions, sorted by frequency. Optionally filter by search prefix.',
  })
  @ApiResponse({
    status: 200,
  ...
  async getProducts(@Query() query: AutocompleteQueryDto) {
    const suggestions = await this.autocompleteService.getProducts(
      query.search,
    );
    return { suggestions };
  }
  ...
  @ApiOperation({
    ...
    description:
      'Returns a list of previously used categories, sorted by frequency. Optionally filter by search prefix.',
  })
  @ApiResponse({
    status: 200,
  ...
  async getCategories(@Query() query: AutocompleteQueryDto) {
    const suggestions = await this.autocompleteService.getCategories(
      query.search,
    );
    return { suggestions };
  }
  ...
  @ApiOperation({
    ...
    description:
      'Returns a list of previously used tags, sorted by frequency. Optionally filter by search prefix.',
  })
  @ApiResponse({
    status: 200,
